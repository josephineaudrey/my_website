...
top25_alcohol_plot <- top25_alcohol %>%
  ...
  labs(
    x = "Litres of Alcohol", 
    y = "", 
    title = "Top 25 Alcohol Consuming Countries", subtitle = "Belarus, Lithuania, & Andorra", caption = "Source: World Health Organization (GISAH), 2010") + # add labels to axis and title
  NULL
