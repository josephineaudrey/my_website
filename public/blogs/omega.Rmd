...
omega <- read_csv(here::here("content", "blogs", "omega.csv"))
glimpse(omega) # examine the data frame

```

## What is the relationship between salary and gender?
...
```{r, hypothesis_testing executives}
# hypothesis testing using t.test() 
...
```{r, hypothesis_testing simulation}
# hypothesis testing using t.test() 
